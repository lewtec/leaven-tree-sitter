...
func tree_sitter_objdump_external_scanner_scan(payload *byte, lexer *TSLexer, valid_symbols *byte) bool {
	...
	*valid_symbols_addr = valid_symbols
	...
	arrayidx = libc.AddPointer[byte]((*byte)(unsafe.Pointer(v0)), int(int64(2)))
	v1 = *arrayidx
	tobool = (v1 & 1) != 0
	if tobool {
		goto if_then
